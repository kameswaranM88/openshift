...
oc new-app --name=rocky --image quay.io/abdulmajeed86/hello-openshift-rhel8
oc expose svc rocky
sleep 5
...
oc new-app --name=oxcart --image quay.io/abdulmajeed86/hello-openshift-rhel8
oc expose svc oxcart --hostname=oxcart.apps.ocp4.example.com
sleep 5

echo "-----------------Creating Lerna Project and Resources------------"
oc new-project lerna
oc new-app --name=hydra --image quay.io/abdulmajeed86/hello-openshift-rhel8
sleep 5

echo "-----------------Creating Gru Project and Resources------------"
oc new-project gru
oc new-app --name=scala --image quay.io/abdulmajeed86/hello-openshift-rhel8
sleep 5

echo "-----------------Creating math Project and Resources------------"
oc new-project math
oc new-app --name=qed --image quay.io/abdulmajeed86/hello-openshift-rhel8
oc expose svc qed --hostname=qed.apps.ocp4.example.com
sleep 5

echo "-----------------Creating Apples Project and Resources------------"
oc new-project apples
oc new-app --name oranges quay.io/abdulmajeed86/myimage
sleep 3
...
oc new-app --name mercury quay.io/abdulmajeed86/hello-openshift-rhel8
